...
def run(
    ...
    for img_file in os.listdir(input_folder):
        input_image = Image.open(os.path.join(input_folder, img_file))
        output = predict(sampler, input_image, prompt, ddim_steps, num_samples, scale, seed)
        import ipdb; ipdb.set_trace()


if __name__ == '__main__':
    run(
        config_path="configs/v2-inpainting-inference.yaml",
